...
% in this figure, we compare the theoretical and monte-carlo estimates
% (in the cases where theoretical estimates are available)
figure;
plot(xv, theory.max.psi, 'g-', ...
     xv, maxpool.psi, 'g:', ...
     xv, theory.avg.psi, 'm-', ...
...
xlabel('pool cardinality');
xlim(m_.xlim);
title('Comparing theoretical and Monte-Carlo results');
